      ...
      <div id="home_content" className="w-[100vw] h-[100vh] flex flex-col justify-center items-center p-10 bg-slate-800">
        <div ref={ref} className="flex gap-16 h-[40rem] z-10 opacity-0 fade-in">
          <div className="relative flex items-center w-[30rem] fade-in hover:w-[31rem] cursor-pointer">
            ...
            <Image src="/img/home01.png" quality={10} alt="logo" fill style={{ objectFit: "cover", borderRadius: '20px', zIndex: -1 }} />
          </div>
          <div className="relative flex items-center w-[30rem] fade-in hover:w-[31rem] cursor-pointer">
            ...
            <Image src="/img/home02.png" quality={10} alt="logo" fill style={{ objectFit: "cover", borderRadius: '20px', zIndex: -1 }} />
          </div>
          <div className="relative flex items-center w-[30rem] fade-in hover:w-[31rem] cursor-pointer">
            ...
            <Image src="/img/home03.png" quality={10} alt="logo" fill style={{ objectFit: "cover", borderRadius: '20px', zIndex: -1 }} />
          </div>
        </div>
      </div >
    </>
